...
export function MysticButton({
  ...
  return (
    <button
      ...
      className={cn(
        "relative inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl px-6 py-2.5 text-sm font-medium transition-all duration-300 disabled:opacity-50",
        variant === "primary" &&
